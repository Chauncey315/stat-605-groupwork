...
Our data is refreshed daily on website, so we use 7 tsv.files(size) from IMDb Datasets on 2019/12/6 and their total size is 4 GB.

The followed are 4 main tsv.files of 7 with description and selected features.
